  ...
  return `<html>
    ...
    <tbody>
          <tr>
            ...
            <img src="#" alt="Lawyer-consult">
            </td>
            </tr>
            <tr>
            <td>
            <p style="margin-top: 0;">Hello,</p>
            <p>Thank you for signing  up with us. Please verify your email to finish signing up with Lawyer-consult. Use the following verification code:</p>
            ...
            <p style="margin-top: 0; font-size: 14px;">Lawyer-consult</p>
            </td>
            </tr>
            </tbody>
            </table>
...
exports.signupSuccess = () => {
  return `<html lang="en">
    ...
    <img src="https://example.com/logo.png" alt="Lawyer-consult" style="display:block; margin:0 auto; max-width:150px;">
    ...
    body {
      ...
      -moz-osx-font-smoothing: grayscale;
            ...
            .footer {
              ...
              <div class="footer">
              <p>© 2023 Lawyer-consult. All rights reserved.</p>
              </div>
              </div>        
          </body>
          </html>`;
          ...
          <meta name="viewport" content="width=device-width, initial-scale=1.0">
            ...
            <body style="font-family: Arial, sans-serif; font-size: 16px; line-height: 1.6; color: #333; background-color: #f4f4f4; padding: 20px;">
              <div style="background-color: #fff; max-width: 600px; margin: 0 auto; border-radius: 5px; padding: 40px;">
                ...
                <p style="margin-bottom: 20px;">You recently requested to reset your password for <b>Lawyer-consult.</b> Click the button below to set a new password:</p>
                ...
                <p style="margin-bottom: 20px;">Best regards,<br><b>Lawyer-consult</b> Team</p>
              </div>
            </body>
          </html>
  `;
